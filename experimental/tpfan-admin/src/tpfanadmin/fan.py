...
class Fan(gtk.DrawingArea):
    ...
    def __init__(self, wanted_width, wanted_height, data_dir):
        ...
        self.fan_border_svg = rsvg.Handle(file = self.data_dir +  build.fan_border_filename)
        self.fan_blades_svg = rsvg.Handle(file = self.data_dir +  build.fan_blades_filename)
